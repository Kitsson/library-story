...
```
Task(
  prompt="Read /home/user/library-story/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/library-story/.claude/get-shit-done/templates/VALIDATION.md`
