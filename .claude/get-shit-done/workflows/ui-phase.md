...
```markdown
Read /home/user/library-story/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/library-story/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/library-story/.claude/agents/gsd-ui-checker.md for instructions.
