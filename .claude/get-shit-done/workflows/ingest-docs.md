...
```bash
INIT=$(node "/home/user/library-story/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/user/library-story/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
