...
<required_reading>
@/home/user/library-story/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/library-story/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/library-story/.claude
                  → checks /home/user/library-story/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/library-story/.claude/get-shit-done
                  → writes to /home/user/library-story/.claude/get-shit-done/hooks/
...
@/home/user/library-story/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/library-story/.claude/get-shit-done/references/common-bug-patterns.md
