...
Reference full template: `/home/user/library-story/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/library-story/.claude/get-shit-done/templates/state.md`.
