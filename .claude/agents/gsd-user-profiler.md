...
<reference>
@/home/user/library-story/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/library-story/.claude/get-shit-done/references/user-profiling.md` to load:
