...
Use template from `/home/user/library-story/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/library-story/.claude/get-shit-done/templates/UI-SPEC.md`
