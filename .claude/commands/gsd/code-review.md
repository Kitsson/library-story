...
<execution_context>
@/home/user/library-story/.claude/get-shit-done/workflows/code-review.md
</execution_context>
...
Execute the code-review workflow from @/home/user/library-story/.claude/get-shit-done/workflows/code-review.md end-to-end.
