...
<execution_context>
@/home/user/library-story/.claude/get-shit-done/workflows/inbox.md
</execution_context>
...
<process>
Execute the inbox workflow from @/home/user/library-story/.claude/get-shit-done/workflows/inbox.md end-to-end.
