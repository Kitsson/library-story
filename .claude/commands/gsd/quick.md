...
<execution_context>
@/home/user/library-story/.claude/get-shit-done/workflows/quick.md
</execution_context>
...
Execute the quick workflow from @/home/user/library-story/.claude/get-shit-done/workflows/quick.md end-to-end.
