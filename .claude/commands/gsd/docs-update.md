...
<execution_context>
@/home/user/library-story/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/home/user/library-story/.claude/get-shit-done/workflows/docs-update.md end-to-end.
