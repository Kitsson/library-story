...
<execution_context>
@/home/user/library-story/.claude/get-shit-done/workflows/health.md
</execution_context>

<process>
Execute the health workflow from @/home/user/library-story/.claude/get-shit-done/workflows/health.md end-to-end.
