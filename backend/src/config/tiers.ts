...
export const TIER_PRICE_MAP: Record<'KLARSTART' | 'KLARPRO' | 'KLARFIRM', string> = {
  KLARSTART: 'price_1TQDynGd49W60xYGre2aRiOO',
  KLARPRO:   'price_1TQE4DGd49W60xYGR36TO7D3',
  KLARFIRM:  'price_1TQE6kGd49W60xYGnEICl8aA',
};

export const TIER_ORDER: Record<'KLARSTART' | 'KLARPRO' | 'KLARFIRM', number> = {
  KLARSTART: 0,
  KLARPRO:   1,
  KLARFIRM:  2,
};
